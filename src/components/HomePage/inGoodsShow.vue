<template>
    <div id="inGoodsShow">
        <el-row :gutter="20">
            <el-col :span="6"><div @click="selectMySelf" class="top-button flash-button"><i class="fa fa-search"></i> 查询自己的入库信息</div></el-col>
        </el-row>
        ...
        <el-dialog title="自己的入库信息" v-model="dialogTableVisible">
